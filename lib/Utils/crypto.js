...
async function hkdf(buffer, expandedLength, info) {
    ...
    const importedKey = await crypto_1.subtle.importKey('raw', inputKeyMaterial, { name: 'HKDF' }, false, ['deriveBits']);
...
async function derivePairingCodeKey(pairingCode, salt) {
    ...
    const keyMaterial = await crypto_1.subtle.importKey('raw', pairingCodeBuffer, { name: 'PBKDF2' }, false, ['deriveBits']);
